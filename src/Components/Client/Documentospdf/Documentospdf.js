    ...
    <section>
      <div className="container mt-5 mb-5">
        <div className="carousel-bx wow zoomIn">
          ...
          <p className="col-sm-12 col-lg-8 mx-auto mb-5">
            Estos son los documentos que se necesitan para registrar a nuestros
            clientes en plataforma porfavor asegurate de que esten correctamente
            diligenciados
          </p>
          <div className="container text-center">
            <div className="row">
              <div className="col">
                ...
                <div>
                  <a className="btn descargar" href={doc1} download>
                    Descargar
                  </a>
                </div>
              </div>
              <div className="col">
                ...
                <div>
                  <a className="btn  descargar" href={doc2} download>
                    Descargar
                  </a>
                </div>
              </div>
              <div className="col">
                ...
                <div>
                  <a className="btn  descargar" href={doc3} download>
                    Descargar
                  </a>
                </div>
              </div>
              <div className="col">
                ...
                <div>
                  <a className="btn descargar" href={doc4} download>
                    Descargar
                  </a>
                </div>
              </div>
